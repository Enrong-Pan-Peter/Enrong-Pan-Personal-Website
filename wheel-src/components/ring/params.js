...
export function defaultParams() {
  return {
    ...
    refWidth: 1512,
    refHeight: 1900, // raised so the ring sits back and the neighbours peek in
    fitHeight: 1, // 0 = width alone drives scale, 1 = whichever axis is tighter
    minScale: 0.36, // a phone is not a small desktop; bracket the extremes
    maxScale: 1.75,
    ...
    planeSize: 92, // long edge in px; aspect locked at 1.5 : 1
    ...
    autoDelay: 6.5, // s of idle before the ring turns itself one card
    dragSpeed: 1,
    ...
    metaGapL: 4.7,
    metaGapR: 3.6,
    metaWidth: 22, // this box is the filter region
    nameSize: (18 / 1440) * 100, // vw, quoted at 1440
    nameFont: "Satoshi",
    nameWeight: 500,
    idxSize: (13 / 1440) * 100, // a step lighter and smaller than the name
    idxFont: "Geist",
    idxWeight: 400,
